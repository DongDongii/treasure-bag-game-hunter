...
export const translations = {
  en: {
    ...
    "home.viewMoreGames": "View More",
    "home.searchGames": "Search games...",
    "home.noGamesFound": "No games found",
    "home.cantFindGame": "Can't find the game you're looking for?",
    "home.contactUsForGame": "Contact us for this game",
    ...
    "items.back": "Back",
    "items.reset": "Reset",
    "items.resetFilters": "Reset Filters",
    "items.applyFilters": "Apply Filters",
    "items.copy": "Copy",
    "items.supportedPlatforms": "Supported Platforms",
    "items.selectPlatform": "Select Platform",
    "items.selectPlatformDesc": "Choose which platform to include in the copied information:",
    "items.cancel": "Cancel",
  ...
  zh: {
    ...
    "home.viewMoreGames": "查看更多游戏",
    "home.searchGames": "搜索游戏...",
    "home.noGamesFound": "未找到游戏",
    "home.cantFindGame": "找不到您要的游戏？",
    "home.contactUsForGame": "联系我们添加此游戏",
    ...
    "items.back": "返回",
    "items.reset": "重置",
    "items.resetFilters": "重置筛选",
    "items.applyFilters": "应用筛选",
    "items.copy": "复制",
    "items.supportedPlatforms": "支持平台",
    "items.selectPlatform": "选择平台",
    "items.selectPlatformDesc": "选择要包含在复制信息中的平台：",
    "items.cancel": "取消",
